(function(){
    ...
    module.exports = {
        info: function(){
            ...
            console.log("======");
            console.log();
            console.log("bearhanded install - Skeleton App with Guided Install");
            console.log();
            console.log("bearhanded update - Update bearhanded code to be the latest and greatest (or repair something you broke)");
        }
    };
}());